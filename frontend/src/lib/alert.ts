...
export const alertPrompt = async (title: string, placeholder = "") => {
...
export const alertConfirmProject = async (message: string) => {
  const result = await Swal.fire({
    title: "Hapus Project?",
    text: message,
    icon: "question",
...
export const alertConfirmContact = async (message: string) => {
  const result = await Swal.fire({
    title: "Hapus Contact?",
    text: message,
    icon: "question",
...
export const alertConfirmVisitor = async (message: string) => {
  const result = await Swal.fire({
    ...neoBrutalistConfig,
    title: "Are you sure?",
    text: message,
...
export const alertConfirmClearAllVisitors = async (message: string) => {
  const result = await Swal.fire({
    ...neoBrutalistConfig,
...
export const alertSuccessVisitor = async (title: string, message: string) => {
  return Swal.fire({
    ...neoBrutalistConfig,
    title: title,
    text: message,
