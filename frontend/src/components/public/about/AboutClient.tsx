      ...
      <section className="-mt-30 md:-mt-12 min-h-screen flex justify-center py-24 px-4 sm:px-6 font-sans text-black dark:text-white">
          <div className="container max-w-[650px] w-full flex flex-col space-y-12 mt-10 mx-auto">
            ...
            <div className="flex flex-col space-y-4">
              <h1 className="text-2xl md:text-3xl font-bold tracking-wide text-black dark:text-white">
                Gilang Abdian
              </h1>

              <div className="space-y-6 text-sm md:text-base text-gray-700 dark:text-gray-300 font-normal leading-relaxed">
                <p>
